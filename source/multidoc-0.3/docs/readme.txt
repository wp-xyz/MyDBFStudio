  ...
  Contributions sent by Júnior Gonçalves, <hipernetjr@yahoo.com.br>
...
Description:
  ...
  (TScrollBox). It must work on all the Lazarus platform without change.
...
Version 0.3 2007/12/31 Fixed the following:
	- Through of {$IFDEF}'s the component compiles into Lazarus/Delphi unchanged
	- Great move. Now the mouse not "escape" while the cursor is dragged
	- ChildDoc is now derived from TFormPanel (see suite LMDI)
	- No more code necessary on each component to focus child form
	- It is possible to change the "skin" of the title bar, according to the OS (see component TTitleBar)
